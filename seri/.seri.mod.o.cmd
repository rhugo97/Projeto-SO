cmd_/host/seri/seri.mod.o := gcc -m32 -Wp,-MD,/host/seri/.seri.mod.o.d  -nostdinc -isystem /usr/lib/gcc/i486-linux-gnu/4.1.2/include -D__KERNEL__ -Iinclude  -include include/linux/autoconf.h -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -O2 -pipe -msoft-float -mpreferred-stack-boundary=2  -march=i686  -mregparm=3 -ffreestanding -maccumulate-outgoing-args -DCONFIG_AS_CFI=1 -DCONFIG_AS_CFI_SIGNAL_FRAME=1 -Iinclude/asm-i386/mach-default -fomit-frame-pointer  -fno-stack-protector -Wdeclaration-after-statement -Wno-pointer-sign    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(seri.mod)"  -D"KBUILD_MODNAME=KBUILD_STR(seri)" -DMODULE -c -o /host/seri/seri.mod.o /host/seri/seri.mod.c

deps_/host/seri/seri.mod.o := \
  /host/seri/seri.mod.c \
...
/host/seri/seri.mod.o: $(deps_/host/seri/seri.mod.o)
